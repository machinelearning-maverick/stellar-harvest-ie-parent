...
1. **[stellar-harvest-ie-config](https://github.com/machinelearning-maverick/stellar-harvest-ie-config)**
...
2. **[stellar-harvest-ie-models](https://github.com/machinelearning-maverick/stellar-harvest-ie-models)**
...
3. **[stellar-harvest-ie-producers](https://github.com/machinelearning-maverick/stellar-harvest-ie-producers)**
...
4. **[stellar-harvest-ie-stream](https://github.com/machinelearning-maverick/stellar-harvest-ie-stream)**

    Thin wrapper around Kafka client factories and stream configuration.

    * Depends on stellar-harvest-ie-producers

5. **[stellar-harvest-ie-consumers](https://github.com/machinelearning-maverick/stellar-harvest-ie-consumers)**
...
6. **[stellar-harvest-ie-store](https://github.com/machinelearning-maverick/stellar-harvest-ie-store)**
...
7. **[stellar-harvest-ie-ui](https://github.com/machinelearning-maverick/stellar-harvest-ie-ui)**

    FastAPI-based UI/dashboard service, real-time and REST API.

8. **[stellar-harvest-ie-ml-stellar](https://github.com/machinelearning-maverick/stellar-harvest-ie-ml-stellar)**

    Machine learning pipelines for training and serving predictive models on stellar (space weather) data.

9. **[stellar-harvest-ie-deployment](https://github.com/machinelearning-maverick/stellar-harvest-ie-deployment)**
